...
_SYSTEM_PROMPT = (
    ...
    "titles, drugs, or structural risks ONLY IF they are explicitly mentioned in the provided context. "
    "Never use generic umbrella terms when the exact name is available in the data, "
    "but NEVER invent or hallucinate names.\n\n"
    "## thesis field\n"
